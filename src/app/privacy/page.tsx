...
export const metadata: Metadata = {
  title: "Chính sách quyền riêng tư | D.C FUNNEL CRM",
  description: "Chính sách quyền riêng tư của D.C FUNNEL CRM cho người dùng và Meta App Review.",
};
...
const dataItems = [
  ...
  "Thông tin khách hàng do người dùng nhập vào CRM như tên, số điện thoại, email, ghi chú, đơn hàng, trạng thái pipeline.",
];
    ...
    <main className="min-h-screen bg-slate-50 px-5 py-10 text-slate-900">
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
        ...
        <section className="mt-8 space-y-4">
          <p>
            D.C FUNNEL CRM là hệ thống CRM/funnel giúp doanh nghiệp quản lý khách hàng, tin nhắn,
            bình luận, fanpage, pipeline bán hàng và chăm sóc khách hàng.
          </p>
          <p>
            Hệ thống được vận hành bởi Hồng Đức Digital / D.C Group để phục vụ người dùng đã đăng
            nhập và các workspace/brand tương ứng.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-4">
          ...
          <p>D.C FUNNEL CRM không bán dữ liệu người dùng cho bên thứ ba.</p>
          <p>
            Dữ liệu chỉ được sử dụng để cung cấp tính năng CRM/funnel cho người dùng đã đăng nhập
            và workspace/brand tương ứng.
          </p>
          <p>
