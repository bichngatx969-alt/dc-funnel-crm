...
export const metadata: Metadata = {
  title: "Điều khoản dịch vụ | DCOS",
  description: "Điều khoản dịch vụ của DCOS cho người dùng và Meta App Review.",
};

const terms = [
  "Bằng việc sử dụng DCOS, người dùng đồng ý sử dụng hệ thống đúng mục đích điều hành khách hàng, kênh bán hàng và workspace kinh doanh.",
  ...
  "DCOS có thể tạm ngưng quyền truy cập nếu phát hiện hành vi lạm dụng hoặc gây rủi ro bảo mật.",
  "Dịch vụ có thể thay đổi, nâng cấp hoặc bảo trì theo nhu cầu vận hành.",
  "DCOS không cam kết hệ thống không bao giờ gián đoạn.",
  "Hệ thống hỗ trợ vận hành bán hàng/Customer OS; người dùng tự chịu trách nhiệm về quyết định kinh doanh và nội dung giao tiếp với khách hàng.",
];
